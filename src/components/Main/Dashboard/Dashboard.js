...
function Dashboard() {
    function optionActived() {
        const listOptionScActive = document.querySelector(".list-option-sc-active");

        listOptionScActive.innerHTML = `
        <svg width="13" height="10" viewBox="0 0 13 10" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M0.96875 4.85894L4.50044 8.39062L12.0004 0.890625" stroke="#AD1FEA" stroke-width="2"/>
        </svg>
        `

        let optionMenu = document.querySelector(".option-menu");
        const windCelBm_icon = document.querySelector(".wind-cel-bm_icon");

        optionMenu.classList.toggle("active-option");
        windCelBm_icon.classList.toggle("rotateActived");
    }
    return(
                ...
                <aside className="feed-card">
                    <div className="cross-box">
                        <div className="beta-card">
                            <svg className="betaCase-icon" width="11" height="7" viewBox="0 0 11 7" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path className="betaCasePath-icon" d="M1.33398 6L5.33398 2L9.33398 6" stroke="#4661E6" stroke-width="2"/>
                            </svg>
                            <span className="betaCaseCounter">99</span>
                        </div>
                    </div>
                    <div className="feed-body">
                        <span className="feedTitle">Add tags for solution</span>
                        <span className="feedBText">Easier to search for solution based on a specific stack.</span>
                        <Link to="/" className="getFeel">Enhancement</Link>
                    </div>
                    <div className="ms-part">
                        ...
                        <div className="ms-c-box">
                            <span className="f-ms-counter" id="f-ms-counter">2</span>
                        </div>
                    </div>
                </aside>
                <aside className="feed-card">
